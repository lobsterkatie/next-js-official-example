...
/**
 * TODO:
 * Rename things after what they are rather than numbers
 * Add context (mechanism and request data) tp _error
 * Client test 1 thows when you load the index page
 *
 */
    ...
    <p>
      ...
      <ol>
        ...
        <li>
          ...
          transactions in Sentry and can be found in the{" "}
          <a href="https://docs.sentry.io/product/sentry-basics/tracing/trace-view/">
            trace navigator
          </a>
          .
        </li>
